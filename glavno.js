...
const files = ['kompanije.js', 'narudzbenice.js', 'piktogrami.js' ,  'tipoviprimene.js', 'server.js',   'specifikacije.js',  'proizvodi.js',  'users.js', 'login.js', 'nalog.js','stripe.js', 'poruke.js'];
