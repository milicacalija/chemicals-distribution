...
app.get("/specifikacije", function(req,res){
...
/*Zatim uvodimo prolazimo kroz if naredbu, oznaka!== znaci nije/
    ...
    app.post ("/specifikacije", function(req,res){
...
app.put("/specifikacije", function(req,res){
...
app.delete("/specifikacije", function(req,res){
